    ...
    try:
        ...
        for ttl in range(1, max_hops + 1):
            ...
            if reached_dest and retry == retries - 1:
                print(Fore.YELLOW + f"Traceroute to {dest_ip} ({dest_addr}) over!")
                break
...
if __name__ == '__main__':
    ...
    #python traceroute.py --destination lancaster.ac.uk --max-hops 30 --timeout 3 --retries 1 --protocol ICMP
    ##python traceroute.py --destination www.youku.com --max-hops 30 --timeout 3 --retries 1 --protocol ICMP
    #python traceroute.py --destination lancaster.ac.uk --max-hops 30 --timeout 3 --retries 3 --protocol UDP (Only in Linux)