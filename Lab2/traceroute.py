...
if __name__ == '__main__':
    ...
    #python traceroute.py lancaster.ac.uk --max-hops 30 --timeout 3 --retries 3 --protocol ICMP
    #python traceroute.py lancaster.ac.uk --max-hops 30 --timeout 3 --retries 3 --protocol UDP